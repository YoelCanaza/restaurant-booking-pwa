...
export const MOCK_PLATOS: Plato[] = [
  // SOPAS
  {
    ...
    precio: 12.0,
    categoria: 'sopas',
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Caldo_de_cabeza_18092010.JPG?width=600',
    disponible: true,
  ...
  },
  {
    ...
    precio: 10.0,
    categoria: 'sopas',
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Sopa_de_Quinua,_plato_típico_boliviano.jpg?width=600',
    disponible: true,
  ...
  },
  {
    ...
    precio: 22.0,
    categoria: 'sopas',
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Chupe_de_camarones_20100512.JPG?width=600',
    disponible: true,
  ...
  // SEGUNDOS
  {
    ...
    precio: 28.0,
    categoria: 'segundos',
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/TruchaFrita.jpg?width=600',
    disponible: true,
    tiempoPreparacion: 20,
    popularidad: 100,
  },
  {
    ...
    precio: 32.0,
    categoria: 'segundos',
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Chicharrones_de_cerdo.jpg?width=600',
    disponible: true,
  ...
  },
  {
    ...
    precio: 42.0,
    categoria: 'segundos',
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Cuy_chactao.jpg?width=600',
    disponible: false,
  ...
  },
  {
    ...
    precio: 18.0,
    categoria: 'segundos',
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Huatia.jpg?width=600',
    disponible: true,
  ...
  // ENTRADAS
  {
    ...
    precio: 14.0,
    categoria: 'entradas',
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Ocopa_(Peru).JPG?width=600',
    disponible: true,
  ...
  },
  {
    ...
    precio: 8.0,
    categoria: 'postres',
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Arroz_con_leche.jpg?width=600',
    disponible: true,
    tiempoPreparacion: 10,
  },
  // BEBIDAS
  {
    ...
    precio: 12.0,
    categoria: 'bebidas',
    imageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Chicha_morada.jpg?width=600',
    disponible: true,
    tiempoPreparacion: 5,
  },
]
...
export const MOCK_PEDIDOS: Pedido[] = [
  ...
  // Pedido de Salón — mesa 2, ya servido (cliente comiendo, listo para pedir cuenta)
  {
    ...
    clienteTelefono: '',
    items: [
      { platoId: 'plato_01', nombre: 'Caldo de Cabeza de Cordero', precio: 12.0, cantidad: 2 },
      { platoId: 'plato_06', nombre: 'Cancacho al Horno', precio: 38.0, cantidad: 1 },
